...
9. Cteate a page link "thank-you" to redirect after transaction
...
== Changelog ==
= 2.2 =
* Capable with Wordpress 6.4.3

= 2.1 =
* Capable with Wordpress 5.3.2

= 2.0 =
* @mrakor https://wordpress.org/support/topic/orders-marked-pending/

= 1.9 =
* 403 error when returning to site after transaction
